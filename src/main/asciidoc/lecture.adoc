...
* Github "used by": 800+ repositories
* Some of notable users include:
** `YunaiV/yudao-cloud` (18k stars)
** `prestodb/presto` (17k stars)
** `apache/druid` (14k stars)
** `dropwizard/dropwizard-redis/`  (part of dropwizard.io ecosystem, 7k stars)
** `slackapi/java-slack-sdk/`  (part of Slack ecosystem)
** `GoogleCloudPlatform/DataflowTemplates` (1.3k stars, project of cloud.google.com)
...
set xrange [1:246]
plot (x<=166?f(x):1/0) with boxes lc 2, (x>166?f(x):1/0) with boxes lc 7
....
